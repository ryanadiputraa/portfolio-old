...
export const SideNav = ({ pages }: Props) => {
  ...
  return (
    <nav
      id="side-nav"
      className="flex flex-col items-start w-full min-h-screen fixed z-50 top-0 left-0 p-6 bg-white/95 dark:bg-black/95 -translate-x-full transition-transform "
    >
