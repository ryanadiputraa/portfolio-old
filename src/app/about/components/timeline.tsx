...
export const Timeline = ({ experience }: Props) => (
	<div className="flex w-full min-h-[5rem] gap-4">
		<div className="text-right flex-[2]">
			...
			<span className="text-sm text-gray-700 dark:text-gray-300 italic">{experience.date}</span>
		</div>
		...
		<div className="flex flex-col text-left items-start flex-[3]">
			...
			<p className="text-gray-700 dark:text-gray-300 italic">{experience.description}</p>
		</div>
	</div>
);
