  ...
  return (
    <div className="w-full flex flex-col justify-center items-center px-4">
      ...
      <div className="flex justify-center items-center mt-6 text-3xl sm:text-5xl gap-4 sm:gap-8">
        ...
        <a className="text-blue-400" href="https://www.linkedin.com/in/ryanadiputraa/" target="_blank" rel="noreferrer">
        ...
        <a className="text-blue-600" href="mailto:ryannadiputraa@gmail.com" target="_blank" rel="noreferrer">
        ...
        <a className="text-red-400" href="/file/RESUME.docx.pdf" download target="_blank" rel="noreferrer">
